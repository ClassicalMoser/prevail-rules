...
describe("exploreCommanderMoves", () => {
  ...
  describe("obstacle handling", () => {
    it("given not move into enemy spaces", () => {
      ...
      gameState.boardState = addCommanderToBoard(gameState.boardState, "white", "E-5");
      const legalMoves = exploreCommanderMoves("white", "E-5", gameState, maxDistance);
    ...
    it("given not move through a diagonal line of friendly units", () => {
      ...
      gameState.boardState = addCommanderToBoard(gameState.boardState, "black", "E-5");
      const legalMoves = exploreCommanderMoves("black", "E-5", gameState, maxDistance);
