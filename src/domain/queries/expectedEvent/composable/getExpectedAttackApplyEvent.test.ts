...
describe("getExpectedAttackApplyEvent", () => {
  ...
  describe("rout priority", () => {
    ...
    it("given when rout is completed and attack apply is also completed, throws", () => {
      ...
      expect(() => getExpectedAttackApplyEvent(attackApplyState, createEmptyGameState())).toThrow(
        "Attack apply state is already complete",
      );
    });
  });
  ...
  describe("retreat", () => {
    ...
    it("given continue to completeAttackApply when retreat is completed", () => {
      ...
      const attackApplyState = createAttackApplyStateWithRetreat(unitPlacement, {
  ...
  describe("error cases", () => {
    it("given when no results are reported, throws", () => {
      ...
      expect(() => getExpectedAttackApplyEvent(attackApplyState, createEmptyGameState())).toThrow(
        "Attack apply state not initialized correctly",
      );
    });
