...
> = Extract<
  PlayerChoiceEventUnionForBoard<TBoard>,
  { choiceType: TPlayerChoiceType }
>;
...
type SmallPlayerChoiceEventSchemaType = z.infer<
  typeof _smallPlayerChoiceEventSchemaObject
>;

export const smallPlayerChoiceEventSchema: z.ZodType<
  PlayerChoiceEventForBoard<SmallBoard>
> = _smallPlayerChoiceEventSchemaObject;

const _standardPlayerChoiceEventSchemaObject = z.discriminatedUnion(
  'choiceType',
  [
    chooseCardEventSchema,
    standardChooseMeleeResolutionEventSchema,
...
type StandardPlayerChoiceEventSchemaType = z.infer<
  typeof _standardPlayerChoiceEventSchemaObject
>;
...
export const standardPlayerChoiceEventSchema: z.ZodType<
  PlayerChoiceEventForBoard<StandardBoard>
...
type LargePlayerChoiceEventSchemaType = z.infer<
  typeof _largePlayerChoiceEventSchemaObject
>;
...
export const largePlayerChoiceEventSchema: z.ZodType<
  PlayerChoiceEventForBoard<LargeBoard>
