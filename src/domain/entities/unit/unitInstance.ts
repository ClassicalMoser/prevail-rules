 ...
 */
export const unitInstanceSchema: z.ZodType<UnitInstance> = _unitInstanceSchemaObject;

// Verify manual type matches schema inference
const _assertExactUnitInstance: AssertExact<UnitInstance, UnitInstanceSchemaType> = true;
