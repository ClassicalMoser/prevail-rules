...
export const diagonalFacings = ["northEast", "southEast", "southWest", "northWest"] as const;

/**
 * The facing direction of a unit.
 */
export type UnitFacing = (typeof orthogonalFacings)[number] | (typeof diagonalFacings)[number];

/**
 * List of valid facing directions for a unit.
 */
export const unitFacings: readonly UnitFacing[] = [...orthogonalFacings, ...diagonalFacings];
...
const _assertExactUnitFacing: AssertExact<UnitFacing, unitFacingSchemaType> = true;
