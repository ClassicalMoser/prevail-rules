import type { SingleUnitPresence, UnitPresence } from "@entities/unitPresence";
 ...
 */
export function hasSingleUnit(unitPresence: UnitPresence): unitPresence is SingleUnitPresence {
