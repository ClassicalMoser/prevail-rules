 ...
 */
export type StandardBoardCoordinateMap = Record<StandardBoardCoordinate, BoardSpace>;
...
type StandardBoardCoordinateMapSchemaType = z.infer<typeof _standardBoardCoordinateMapSchema>;
