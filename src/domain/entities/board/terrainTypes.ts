 ...
 */
const terrainTypes = ["plain", "rocks", "scrub", "lightForest", "denseForest"] as const;
...
const _terrainTypeSchemaObject = z.enum(terrainTypes).default(terrainTypes[0]);
...
const _assertExactTerrainType: AssertExact<TerrainType, terrainTypeSchemaType> = true;
