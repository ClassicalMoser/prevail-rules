...
import { createBoardWithEngagedUnits, createBoardWithUnits, getUnitByStatValue } from "@testing";
...
describe("isAtPlacement", () => {
  ...
  describe("invalid inputs", () => {
    it("given a non-existent coordinate, returns false", () => {
      ...
      const unitWithPlacement = createUnitWithPlacement(unit, invalidCoordinate, "north");
  ...
  describe("single friendly unit", () => {
    ...
    it("given facing does not match, returns false", () => {
      const unit = createUnit("black");
      const board = createBoardWithUnits([{ unit, coordinate, facing: "north" }]);
      const unitWithPlacement = createUnitWithPlacement(unit, coordinate, "south");
    ...
    it("given playerSide does not match, returns false", () => {
      ...
      const board = createBoardWithUnits([{ unit, coordinate, facing: "north" }]);
      const unitWithPlacement = createUnitWithPlacement(differentPlayerUnit, coordinate, "north");
    ...
    it("given unitType does not match, returns false", () => {
      ...
      const board = createBoardWithUnits([{ unit, coordinate, facing: "north" }]);
      const unitWithPlacement = createUnitWithPlacement(differentTypeUnit, coordinate, "north");
    ...
    it("given instanceNumber does not match, returns false", () => {
      ...
      const differentInstanceUnit = createUnit("black", flexibility1UnitType, 2);
      const board = createBoardWithUnits([{ unit, coordinate, facing: "north" }]);
      const unitWithPlacement = createUnitWithPlacement(differentInstanceUnit, coordinate, "north");
    ...
    it("given unit matches by value (different object reference), returns true", () => {
      ...
      const unitWithPlacement = createUnitWithPlacement(sameUnit, coordinate, "north");
  ...
  describe("single enemy unit", () => {
    it("given unit at coordinate is an enemy, returns false", () => {
      ...
      const unitWithPlacement = createUnitWithPlacement(friendlyUnit, coordinate, "north");
  ...
  describe("engaged units - primary unit is friendly", () => {
    ...
    it("given primary unit facing does not match, returns false", () => {
      ...
      const secondaryUnit = createUnit("white");
      const board = createBoardWithEngagedUnits(primaryUnit, secondaryUnit, coordinate, "north");
      const unitWithPlacement = createUnitWithPlacement(primaryUnit, coordinate, "south");
  ...
  describe("engaged units - secondary unit is friendly", () => {
    ...
    it("given secondary unit facing does not match, returns false", () => {
      ...
      const unitWithPlacement = createUnitWithPlacement(secondaryUnit, coordinate, "north");
    ...
    it("given secondary unit playerSide does not match, returns false", () => {
      ...
      const differentPlayerUnit = createUnit("white");
      const board = createBoardWithEngagedUnits(primaryUnit, secondaryUnit, coordinate, "north");
      const unitWithPlacement = createUnitWithPlacement(differentPlayerUnit, coordinate, "south");
    ...
    it("given secondary unit unitType does not match, returns false", () => {
      ...
      const differentTypeUnit = createUnit("black", flexibility2UnitType);
      const board = createBoardWithEngagedUnits(primaryUnit, secondaryUnit, coordinate, "north");
      const unitWithPlacement = createUnitWithPlacement(differentTypeUnit, coordinate, "south");
    ...
    it("given secondary unit instanceNumber does not match, returns false", () => {
      ...
      const differentInstanceUnit = createUnit("black", flexibility1UnitType, 2);
      const board = createBoardWithEngagedUnits(primaryUnit, secondaryUnit, coordinate, "north");
      const unitWithPlacement = createUnitWithPlacement(differentInstanceUnit, coordinate, "south");
    ...
    it("given secondary unit matches by value with diagonal facing, returns true", () => {
      ...
      const unitWithPlacement = createUnitWithPlacement(secondaryUnit, coordinate, "southWest");
