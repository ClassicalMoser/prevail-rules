...
const _engagementResolutionStateSchemaObject = z.discriminatedUnion("engagementType", [
  frontEngagementResolutionStateSchema,
  flankEngagementResolutionStateSchema,
  rearEngagementResolutionStateSchema,
]);

type EngagementResolutionStateSchemaType = z.infer<typeof _engagementResolutionStateSchemaObject>;
