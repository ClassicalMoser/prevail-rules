...
type PendingCommitmentSchemaType = z.infer<typeof _pendingCommitmentSchemaObject>;

/** The schema for a pending commitment. */
export const pendingCommitmentSchema: z.ZodType<PendingCommitment> = _pendingCommitmentSchemaObject;

const _assertExactPendingCommitment: AssertExact<PendingCommitment, PendingCommitmentSchemaType> =
  true;
...
type DeclinedCommitmentSchemaType = z.infer<typeof _declinedCommitmentSchemaObject>;
...
type CompletedCommitmentSchemaType = z.infer<typeof _completedCommitmentSchemaObject>;
...
export type Commitment = PendingCommitment | DeclinedCommitment | CompletedCommitment;
...
const _assertExactCommitment: AssertExact<Commitment, CommitmentSchemaType> = true;
