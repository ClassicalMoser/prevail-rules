 ...
 *
 * Types here stay **relatively wide** (`Game`, `GameState`, …): adapters
 * only see storage and transport shapes. **Correlated** variants (`GameOfType<T>`, `GameState<BoardForGameMode<T>>`)
