...
describe("getForwardSpace", () => {
  describe("standard board", () => {
    ...
    it("should throw an error if the row is invalid", () => {
      expect(() => getForwardSpace(standardBoard, "R-12", "north")).toThrow(
        new Error("Invalid row: R"),
      );
    });
    it("should throw an error if the column is invalid", () => {
      expect(() => getForwardSpace(standardBoard, "A-19", "north")).toThrow(
        new Error("Invalid column: 19"),
      );
    });
    it("should throw an error if the facing is invalid", () => {
      expect(() => getForwardSpace(standardBoard, "E-9", "random")).toThrow(
  ...
  describe("small board", () => {
    ...
    it("should throw an error if the row is invalid (I doesn't exist in small board)", () => {
      expect(() => getForwardSpace(smallBoard, "I-5", "north")).toThrow(
        new Error("Invalid row: I"),
      );
    });
    it("should throw an error if the row is invalid (L doesn't exist in small board)", () => {
      expect(() => getForwardSpace(smallBoard, "L-5", "north")).toThrow(
    ...
    it("should throw an error if the column is invalid (13 doesn't exist in small board)", () => {
      expect(() => getForwardSpace(smallBoard, "A-13", "north")).toThrow(
        new Error("Invalid column: 13"),
      );
    });
    it("should throw an error if the column is invalid (18 doesn't exist in small board)", () => {
      expect(() => getForwardSpace(smallBoard, "A-18", "north")).toThrow(
        new Error("Invalid column: 18"),
      );
    });
    it("should throw an error if the facing is invalid", () => {
      expect(() => getForwardSpace(smallBoard, "E-9", "random")).toThrow(
        new Error("Invalid facing: random"),
      );
    });
  });
