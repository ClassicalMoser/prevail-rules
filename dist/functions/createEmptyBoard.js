import { largeBoardConfig, smallBoardConfig, standardBoardConfig, } from "../entities/board/boardConfig.js";
/**
 ...
 */
export function createEmptyLargeBoard() {
    return createEmptyBoardWithConfig("large", largeBoardConfig);
}
