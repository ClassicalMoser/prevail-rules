...
describe("isLegalCommanderMove", () => {
    // Helper function to create a board with a commander at a coordinate
    function createBoardWithCommander(player, coordinate) {
        const board = createEmptyStandardBoard();
        board.board[coordinate] = {
            ...board.board[coordinate],
            commanders: new Set([player]),
        };
        return board;
    }
