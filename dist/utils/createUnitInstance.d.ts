 ...
 * them too brittle.
 */
export declare function createUnitInstance(playerSide: PlayerSide, unitType: UnitType, instanceNumber: number): UnitInstance;
//# sourceMappingURL=createUnitInstance.d.ts.map