...
describe("getUnitByStatValue", () => {
    ...
    it("should throw an error when no unit is found with the specified stat value", () => {
        ...
        expect(() => getUnitByStatValue("attack", 999)).toThrow(new Error("No unit found with attack value 999."));
    });
    it("should throw an error with correct message format for different stats", () => {
        ...
        expect(() => getUnitByStatValue("speed", 999)).toThrow(new Error("No unit found with speed value 999."));
        expect(() => getUnitByStatValue("flexibility", 999)).toThrow(new Error("No unit found with flexibility value 999."));
    });
});
